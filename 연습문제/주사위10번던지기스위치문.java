	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			case 2:
				++주사위눈횟수[1];
					//count++;
					//System.out.println("2이나온횟수"+count);
					break;
				
			case 3:
				++주사위눈횟수[2];
					//count++;
					//System.out.println("3이나온횟수"+count);
					break;
				
			case 4:
				++주사위눈횟수[3];
					//count++;
					//System.out.println("4이나온횟수"+count);
					break;
				
			case 5:
				++주사위눈횟수[4];
					//count++;
					//System.out.println("5이나온횟수"+count);
					break;
				
			case 6:
				++주사위눈횟수[5];
					//count++;
//					System.out.println("6이나온횟수"+count);
					break;
